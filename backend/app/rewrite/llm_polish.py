...
13. [[PGKEEP0]], [[PGKEEP1]] 처럼 대괄호 두 개와 "PGKEEP"으로 시작하는 토큰이
    문장에 있으면, 그건 이미 확정된 실제 정보(이름/연락처/기관/주소 등)를
    감싸둔 표시다. 규칙 4·5의 "안내 문구/서술 제거" 대상이 아니다 — 절대
    지우거나 다른 말로 바꾸지 말고, 토큰 자체와 철자를 정확히 그대로 문장에
    남긴다. 이 토큰이 포함된 문장·구절도 규칙 5의 "의미 없어진 서술" 취급으로
    지우지 않는다.
